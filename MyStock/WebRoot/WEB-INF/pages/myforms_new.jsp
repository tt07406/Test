...
<link rel="stylesheet" href="front/excel/jQuery.Excel/theams/office/office.css">
</head>
<body>
...
<script type="text/javascript" src="front/excel/jQuery.Excel/js/jQuery.excelFucntions.js"></script>
<script type="text/javascript" src="front/excel/jQuery.Excel/js/jQuery.excelPlugin.js"></script>
...
$(document).ready(function(){
	$("#table").tableGenerate({
		...
		"path":"/front/excel/data/up", //json文件保存路径		
	});
	$("#table").draggable();
});
</script>
