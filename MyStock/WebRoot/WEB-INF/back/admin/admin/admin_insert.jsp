...
<script type="text/javascript">
	function validateAccount(value){
		...
		$("#result").load("<%=request.getContextPath()%>/back/validateName.action",{userName:value,type:1});
	}
</script>
<style type="text/css">
<!--
...
<center> 
<form action="Admin_insert" method="post" onSubmit="return validateAdd(this)">
