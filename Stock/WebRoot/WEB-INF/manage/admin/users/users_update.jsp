...
<center> 
<form action="Users_update" method="post" onSubmit="return validate(this)">
<table border="1" width="100%" cellpadding="5" cellspacing="0" bgcolor="F2F2F2">
	...
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		...
		<td><input type="text" name="realName" onBlur="validateName(this.value)" value="${user.realName}"></td>
	...
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		...
		<td><INPUT TYPE="text" NAME="phone" onBlur="validateTelephone(this.value)" value="${user.userPhone}"></td>
		<td><span id="telephone_msg"><font color="RED">*</font></span></td>
	</tr>
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		<td><font size="2">身份证号：</font></td>
		<td><input type="text" name="idNum" onBlur="validateIdNumber(this.value)" value="${user.userIdNum}"></td>
