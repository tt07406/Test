...
import org.news.hibernate.domain.Admin;
 ...
 * 
 * @see org.news.hibernate.dao.Admin
...
public class AdminDAO extends BaseHibernateDAO {
	...
	public List findByAdminInfo(Object adminInfo) {
		return findByProperty(ADMIN_INFO, adminInfo);
	}
